...
/**
 * Conformance tests for {@link Ym2149AudioRefactored}.
 *
 * <p>Replays the same NVC-generated VCD traces used by the other conformance
 * tests and verifies that {@code Ym2149AudioRefactored} produces bit-identical
 * outputs at every rising {@code clk_i} edge.
 */
class RefactoredConformanceTest {
    ...
    private static void runConformance(Path vcdZip, String label) throws IOException {
        final Ym2149AudioRefactored uut = new Ym2149AudioRefactored();
